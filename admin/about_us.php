            ...
            <div class="container-fluid">
                ...
                if (!empty($_POST)){
                    ...
                    $id = 1;
                        ...
                        $query = $pdo->prepare("UPDATE about_us SET title=:htitle,contents=:hcontents WHERE id=:hid");
                        $query->execute([
                            "htitle"=>$title,
                            "hcontents"=>$contents,
                            "hid"=>$id,
                        ...
                        echo "<script>location.href='about_us.php';</script>";
                ...
                ?>
                 ...
                 <div>
                     <form method="post" action="<?php echo $_SERVER["PHP_SELF"]?>">
                         <input type="text" name="title" placeholder="Enter Title..." value="<?php echo $data["title"] ?>" class="p-2 w-75 mb-4">
