    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">General Site Settings</h1>
                <div>
                    <?php
                    ...
                    <form action="ajax/setting.php"  method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="site_adi">Site Name:</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" accept="image/*" name="logo_image"  class="form-control" id="logo_input" >
                        </div>

                        <div class="form-group">
                            <label for="formGroupExampleInput">Our Opening/Closing Hours</label>
                            <div class="d-flex">
                                <input type="time" name="opening_time" value="<?php echo $ayar["opening_time"]; ?>">
                                <input type="time" name="closing_time" value="<?php echo $ayar["closing_time"]; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput">Short Introduction</label>
                            <textarea name="short_introduction" id="" class="d-block w-100" rows="5"><?php echo $ayar["short_introduction"]; ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <input type="color" name="header_color" class="form-control" value="<?php echo $ayar["header_color"]; ?>">
                                    </td>
                                    <td>
                                        <input type="color" name="footer_color" class="form-control" value="<?php echo $ayar["footer_color"]; ?>">
                                    </td>

                                    <td>
                                        <input type="color" name="bg_color" class="form-control" value="<?php echo $ayar["bg_color"]; ?>">
                                    </td>
                                </tr>
