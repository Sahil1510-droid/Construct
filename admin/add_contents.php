    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Add Content</h1>
                <?php
                if (!empty($_POST)){
                    ...
                    $query= $pdo->prepare("INSERT INTO articles (title,contents,yazi_image) VALUES (:title,:contents,:yazi_image) ");
                    $query->execute([
                            "title"=>$title,
                        "contents"=>$contents,
                        "yazi_image"=>$yol,
                    ]);
                    echo "<script>location.href='add_contents.php'</script>";
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <form method="post" enctype="multipart/form-data">
                                    <input type="text" name="title" placeholder="Enter Title..." class="p-2 w-100 mb-4">
