        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <h1 class="h3 mb-4 text-gray-800">Menu Transaction</h1>
                ...
                <div>
                    <?php
                    $query = $pdo->query("SELECT * FROM menus ORDER BY `order` ASC");
                    $data=$query->fetchAll();
                    $say=1;
                    ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($data as $menu): ?>
                            <tr id="<?= $menu["id"] ?>">
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" class="onay_kontrol" data-id="<?php echo $menu["id"]; ?>" <?php echo $menu["status"]==1 ? "checked" : null ?>>
                                        <span class="slider"></span>
                                    </label>
                                </td>
                                <td><?php echo $menu["history"]; ?></td>
                                <td>
                                    <a href="<?php echo "ajax/menu_sil.php?id=".$menu["id"]; ?>" class="btn btn-danger">Delete</a>
                                    <button href="#"  data-toggle="modal" data-target="#düzenle" class="btn btn-warning duzenle">Edit</button>
                                </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="ajax/add_menu.php" method="post">

                    <span class="mb-2 d-block">Menu Ad</span>
                    <input type="text"  class="w-100 p-2 mb-2" name="menu_ad" placeholder="Enter your Menu Name...">



                    <span class="mb-2 d-block">Menu Link</span>
                    <input type="text" name="menu_link" placeholder="Enter the menu link..." class="w-100 p-2 mb-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="ajax/menu_guncelle.php" id="guncelle_form">
                    ...
                    <span class="mb-2 d-block">Menu Ad</span>
                    <input type="text" id="duzenle_ad" class="w-100 p-2 mb-2" name="menu_ad" placeholder="Menu Namenı giriniz...">


                    <span class="mb-2 d-block">Menu Link</span>
                    <input type="text" id="duzenle_link" name="menu_link" placeholder="Menu linkini giriniz..." class="w-100 p-2 mb-2">
...
<script>
    ...
    $( "#sortable" ).sortable({
        ...
        update: function( event, ui ) {
            ...
            $.ajax({
                url:"ajax/menu_orderla.php",
                data:{
                    order_dizi:sortedIDs
                },
                type:"POST",
                success:function (data) {
