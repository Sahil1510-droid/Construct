        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <h1 class="h3 mb-4 text-gray-800">User log</h1>
                    <button class="btn btn-danger"  data-toggle="modal" data-target="#exampleModal">Delete All Logs</button>
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th scope="col">Submit History</th>
                        <th scope="col">Exit History</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    function history_format($history){
                    ...
                    <tr>
                        ...
                        <td><?=history_format($log["entry_history"])?></td>
                        <td><?=history_format($log["exit_history"])?></td>
                    </tr>
                    <?php endforeach; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="ajax/log_sil.php" type="button" class="btn btn-danger">Delete</a>
            </div>
